...
if (!function_exists('pos_icon')) {
    ...
    $GLOBALS['POS_ICONS'] = [
        ...
        'satispay' => [
            'inner' => '<path fill="currentColor" d="M89.742 332.459h85.442l135.021-123.251c6.752-6.163 10.624-14.941 10.624-24.083 0-9.143-3.872-17.92-10.624-24.084L175.184 37.79H89.742c-3.284 0-5.288 2.145-6.066 4.153-.78 2.009-.747 4.941 1.678 7.157l144.633 132.005c1.121 1.024 1.765 2.481 1.765 4.001 0 1.519-.644 2.976-1.765 4L85.354 321.112c-2.425 2.215-2.458 5.149-1.678 7.156.778 2.008 2.782 4.153 6.066 4.153"></path><path fill="currentColor" d="M115.75 99.583 48.42 161.045c-6.751 6.164-10.625 14.941-10.625 24.084 0 9.141 3.874 17.92 10.625 24.082l67.33 61.46 51.11-46.655-38.221-34.888c-1.122-1.024-1.766-2.48-1.766-4 0-1.52.644-2.977 1.766-4.001l38.221-34.888-51.11-46.656"></path><path fill="currentColor" d="M268.885 37.79h-68.793l42.785 39.063 30.393-27.744c2.425-2.216 2.459-5.149 1.68-7.157-.78-2.008-2.782-4.153-6.065-4.153M242.877 293.439l-42.785 39.02h68.793c3.283 0 5.285-2.145 6.065-4.153.779-2.007.745-4.941-1.68-7.156l-30.393-27.711"></path>',
            'attrs' => ['viewBox' => '0 0 358.62668 370.25333', 'fill' => 'currentColor', 'stroke' => null, 'stroke-width' => null, 'stroke-linecap' => null, 'stroke-linejoin' => null],
        ],
        'print' =>
