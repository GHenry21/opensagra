...
- [ ] **Quando lato codice e lato Windows sono completati e verificati** (il resto di questa Fase 5 più i punti ancora aperti di Fase 3/4) → pubblicare il repo su GitHub. Condizione esplicita dell'utente: non prima che quel lavoro sia chiuso. Nota tecnica già presente altrove nel piano: alcuni pezzi (workflow CI del wrapper, badge/link di release) sono **inerti finché il repo non ha un remote GitHub** — diventano attivi da questo punto.
