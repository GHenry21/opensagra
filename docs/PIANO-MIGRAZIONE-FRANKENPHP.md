...
- [ ] **Resta da fare** (elencato in coda alla guida stessa, §10): screenshot reali dei 3 popup Windows + finestra di avanzamento dell'installer (rimandato per non reinstallare MariaDB/FrankenPHP sulla macchina di sviluppo — richiederebbe una VM pulita), installazione del certificato HTTPS su un tablet/telefono esterno, aggiornamento/disinstallazione, casi d'errore comuni.
