...
- [ ] **Il resto resta condizionato**, come deciso: pubblicazione "a pieno titolo" (release, badge CI, annuncio) **solo quando lato codice e lato Windows sono completati e verificati** (il resto di questa Fase 5 più i punti ancora aperti di Fase 3/4). Il repo è già online ma va trattato come "non ancora pronto per un pubblico reale" finché quel lavoro non è chiuso.
...
- [ ] **Resta da fare** (elencato in coda alla guida stessa, §10): installazione del certificato HTTPS su un tablet/telefono esterno, aggiornamento/disinstallazione, casi d'errore comuni.
