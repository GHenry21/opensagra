...
- **Non tracciata** (lasciata alla cronologia git, che rimane l'unico registro): le 11 modifiche/rimozioni sopra sono state `git rm` ma non ancora committate — lasciate in stage per la revisione/commit dell'utente da VSCode Source Control, seguendo la sua prassi abituale.
